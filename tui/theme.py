...
#pwd-box {{ width: 64; height: auto; border: round {BORDER_MUTED}; background: {SURFACE}; padding: 1 2; }}
#pwd-box Button {{
    background: #1f1f1f; color: #e8e8e8;
    border: round {BORDER_MUTED}; text-style: none;
}}
#pwd-box Button:hover, #pwd-box Button:focus {{ border: round {ACCENT}; background: #262626; }}
#pwd-box Horizontal {{ height: auto; }}
#pwd-box Horizontal Button {{ width: 1fr; }}
#acc, #pwd, #sms {{ border: tall {BORDER_MUTED}; background: #101010; }}
